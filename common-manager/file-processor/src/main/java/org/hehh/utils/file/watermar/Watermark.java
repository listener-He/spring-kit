...
public interface Watermark {
     ...
     */
    default boolean text(String origin, String save, String text, int margin_x, int margin_y, float opacity, double markAngle, Color color, int fontSize) throws IOException {
    ...
    default boolean text(File origin, File save, String text, int margin_x, int margin_y, float opacity, double markAngle, Color color, int fontSize) throws IOException {
        return text(origin, save, text, margin_x, margin_y, opacity, markAngle, WatermarkMode.SIMP, color, fontSize);
    }
     ...
     * @throws IOException ioexception
     */
    boolean text(File origin, File save, String text, int margin_x, int margin_y, float opacity, double markAngle, WatermarkMode mode, Color color, int fontSize) throws IOException;
    ...
    default boolean image(File origin, File save, File img, int margin_x, int margin_y, float opacity, double markAngle, Color color) throws IOException {
        return image(origin, save, img, margin_x, margin_y, opacity, markAngle, WatermarkMode.SIMP, color);
    }
     ...
     * @return boolean
     */
    boolean image(File origin, File save, File img, int margin_x, int margin_y, float opacity, double markAngle, WatermarkMode mode, Color color) throws IOException;
    ...
    default boolean tiledText(File origin, File save, String text, float opacity, double markAngle, Color color, int fontSize) throws IOException {
        return text(origin, save, text, -1, -1, opacity, markAngle, WatermarkMode.TILED, color, fontSize);
    }
    ...
    default boolean tiledImage(File origin, File save, File img, float opacity, double markAngle, Color color) throws IOException {
        return image(origin, save, img, -1, -1, opacity, markAngle, WatermarkMode.TILED, color);
    }
}
