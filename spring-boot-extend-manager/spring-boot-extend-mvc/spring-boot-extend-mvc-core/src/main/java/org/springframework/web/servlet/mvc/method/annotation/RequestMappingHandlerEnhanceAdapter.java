...
/**
 * xtension of {@link AbstractHandlerMethodAdapter} that supports
 ...
 * @author: HeHui
 * @create: 2020-03-22 18:19
 * @description: 增强 请求映射处理程序适配器
 **/
public class RequestMappingHandlerEnhanceAdapter extends RequestMappingHandlerAdapter {
     ...
     */
    @Nullable
    private HandlerMethodArgumentResolverComposite defaultArgumentResolvers;
    ...
    public RequestMappingHandlerEnhanceAdapter() {
    ...
    public void setArgumentResolvers(@Nullable List<HandlerMethodArgumentResolver> argumentResolvers) {
        if (argumentResolvers == null) {
             ...
             */
            this.argumentResolvers = defaultArgumentResolvers == null ? new HandlerMethodArgumentResolverComposite() :defaultArgumentResolvers;
    ...
    public void afterPropertiesSet() {
        ...
        if (this.argumentResolvers == null) {
             ...
             * 新增如果默认的有值，使用默认的，如果没有就使用 HandlerMethodArgumentResolverComposite原生的
             */
            this.argumentResolvers = (this.defaultArgumentResolvers == null ? new HandlerMethodArgumentResolverComposite() : this.defaultArgumentResolvers).addResolvers(resolvers);
        }
        if (this.initBinderArgumentResolvers == null) {
             ...
             * 新增如果默认的有值，使用默认的，如果没有就使用 HandlerMethodArgumentResolverComposite原生的
             */
            this.initBinderArgumentResolvers = (this.defaultArgumentResolvers == null ? new HandlerMethodArgumentResolverComposite() : this.defaultArgumentResolvers).addResolvers(resolvers);
        }
    ...
    protected ModelAndView invokeHandlerMethod(HttpServletRequest request,
        ...
        try {
            ...
            }else if(this.defaultArgumentResolvers != null){
                /**
                 *  原无此判断
                 */
                invocableMethod.setHandlerMethodArgumentResolvers(this.defaultArgumentResolvers);
            }
