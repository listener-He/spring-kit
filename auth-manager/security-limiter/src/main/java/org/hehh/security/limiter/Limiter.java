...
public interface Limiter<T> {
     ...
     * @return
     */
    void acquire(LimiterCallback<T> callback) throws LimiterException;
     ...
     * @return
     */
    void acquire(long timeout, TimeUnit unit,LimiterCallback<T> callback) throws LimiterException;
