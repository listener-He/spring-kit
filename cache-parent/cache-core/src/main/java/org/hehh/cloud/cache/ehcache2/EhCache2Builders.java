...
public class EhCache2Builders {
     ...
     */
    public static CacheManager builder(EhCache2ConfigurationParameter parameter) {
        ...
        configuration.setName(parameter.getCacheName());
        if (parameter.getLocalMaxBytesLocalDisk() != null && parameter.getLocalMaxBytesLocalDisk() > 0) {
            configuration.setMaxBytesLocalDisk(parameter.getLocalMaxBytesLocalDisk());
        }
        if (parameter.getLocalMaxBytesLocalHeap() != null && parameter.getLocalMaxBytesLocalHeap() > 0) {
            configuration.setMaxBytesLocalHeap(parameter.getLocalMaxBytesLocalHeap());
        }
        ...
        if (parameter.getCaches() != null && parameter.getCaches().size() > 0) {
            for (EhCache2Parameter cache2Parameter : parameter.getCaches()) {
                ...
                if (cache2Parameter.getMaxEntriesLocalDisk() > 0) {
                    cacheConfiguration.setMaxEntriesLocalDisk(cache2Parameter.getMaxEntriesLocalDisk());
                }
                if (cache2Parameter.getMaxEntriesLocalHeap() > 0) {
                    cacheConfiguration.setMaxEntriesLocalHeap(cache2Parameter.getMaxEntriesLocalHeap());
                }
                ...
                if (cache2Parameter.getLocalMaxBytesLocalDisk() != null && cache2Parameter.getLocalMaxBytesLocalDisk() > 0) {
                    cacheConfiguration.setMaxBytesLocalDisk(cache2Parameter.getLocalMaxBytesLocalDisk());
                }
                if (cache2Parameter.getLocalMaxBytesLocalHeap() != null && cache2Parameter.getLocalMaxBytesLocalHeap() > 0) {
                    cacheConfiguration.setMaxBytesLocalHeap(cache2Parameter.getLocalMaxBytesLocalHeap());
                }
